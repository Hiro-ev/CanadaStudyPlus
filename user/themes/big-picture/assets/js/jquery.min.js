...
("undefined" !=typeof window?window:this, function(C, e) {
		...
		, S.extend( {
										...
										var r, i, o, a, s, u, l=y !==m?"nextSibling":"previousSibling", c=e.parentNode, f=x&&e.nodeName.toLowerCase(), p= !n&& !x, d= !1; if(c) {
											...
											if(u=[m?c.firstChild:c.lastChild], m&&p) {
												d=(s=(r=(i=(o=(a=c)[S]||(a[S]= {}
															...
															))[h]||[])[0]===k&&r[1])&&r[2], a=s&&c.childNodes[s]; while(a=++s&&a&&a[l]||(d=s=0)||u.pop())if(1===a.nodeType&&++d&&a===e) {
													i[h]=[k, s, d]; break
												}
											}
			        ...
			        S.event.add(e, i, {
			            ...
			            handler: function (e) {
			                ...
			                if (1 & e.isTrigger && this[i]) {
			                    if (r.length) {
			                        if (S.event.special[i] && S.event.special[i].delegateType) {
			                            e.stopPropagation();
			                        }
			                    } else {
			                        r = s.call(arguments);
			                        ...
			                        t = o(this, i);
			                        this[i]();
			                        r !== (n = Y.get(this, i)) || t ? Y.set(this, i, false) : n = {};
			                        
			                        // preventDefault() を使用しないように変更
			                        if (r !== n) {
				    ...
				    if (u.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, u)) {
				        ...
				        while ((i = a[t++]) && !u.isPropagationStopped()) {
				            ...
				            while ((o = i.handlers[n++]) && !u.isImmediatePropagationStopped()) {
				                if (u.rnamespace && !1 !== o.namespace && !u.rnamespace.test(o.namespace)) {
				                    u.handleObj = o;
				                    u.data = o.data;
				                    r = ((S.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s);
				                    
				                    // preventDefault()を使用せず、false を戻り値として処理を中断
				                    if (r === false) {
				                        u.stopPropagation();  // イベントの伝播を停止
				                        return false; // false を返してイベントをキャンセル
				                    }
				                }
				            }
				        }
			...
			, S.Event.prototype = {
			    ...
			    // preventDefault() を使用しないように修正
			    preventDefault: function() {
			        var e = this.originalEvent;
			        this.isDefaultPrevented = we;
			        // preventDefault() を呼び出す代わりに、false を返すことで動作をキャンセル
			        if (e && !this.isSimulated) {
			            return false;  // false を返してデフォルトの動作をキャンセル
			        }
			    },

			    // stopPropagation() を使用しないように修正
			    stopPropagation: function() {
			        var e = this.originalEvent;
			        this.isPropagationStopped = we;
			        if (e && !this.isSimulated) {
			            // false を返してイベントの伝播を停止
			            return false;  // false を返してイベントの伝播を止める
			        }
			    },

			    // stopImmediatePropagation() を使用しないように修正
			    stopImmediatePropagation: function() {
			        var e = this.originalEvent;
			        this.isImmediatePropagationStopped = we;
			        if (e && !this.isSimulated) {
			            // false を返して即時の伝播も停止
			            return false;  // false を返して即時伝播も止める
			        }
			        // stopPropagation() を呼び出して伝播を停止
			...
			, S.each( {
			    ...
			    off: function(e, t, n) {
			        ...
			        // 既存の preventDefault() を避け、false を返すことで動作をキャンセル
			        ...
			        // preventDefault() の代わりに false を返す
	    ...
	    trigger: function(e, t, n, r) {
	        ...
	        if (o = f = a = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !mt.test(d + S.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, (e = e[S.expando] ? e : new S.Event(d, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : S.makeArray(t, [e]), c = S.event.special[d] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
	            ...
	            while ((o = p[i++]) && !e.isPropagationStopped()) {
	                f = o, e.type = 1 < i ? s : c.bindType || d, (l = (Y.get(o, "events") || Object.create(null))[e.type] && Y.get(o, "handle")) && l.apply(o, t), (l = u && o[u]) && l.apply && V(o) && (e.result = l.apply(o, t), false === e.result && (e.isDefaultPrevented = we));
	            }
